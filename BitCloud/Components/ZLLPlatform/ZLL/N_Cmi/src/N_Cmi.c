...
{
  NwkNeighbor_t *neighbor = NWK_AddKnownNeighbor(networkAddressEndDevice, (ExtAddr_t*)ieeeAddressEndDevice);
...
void N_Cmi_Join_Impl(N_Beacon_t* pSelectedBeacon, N_Cmi_JoinDone_t pfDoneCallback)
{
  ...
  NwkNeighbor_t *neighbor = NWK_AddKnownNeighbor(pSelectedBeacon->sourceAddress, &extAddr);

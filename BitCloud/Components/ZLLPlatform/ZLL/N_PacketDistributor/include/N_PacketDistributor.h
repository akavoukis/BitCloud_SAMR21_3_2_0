...
/** Register a ZigBee end-point.
    \param pSimpleDescription Pointer to a filled structure describing
        ...
        this function
*/
//void N_PacketDistributor_RegisterInterPanEndpoint(const SimpleDescriptionFormat_t* pSimpleDescription);
...
void N_PacketDistributor_Subscribe(uint8_t endpoint, const IN_AfIncomingData_Callback_t* pCallback);

 ...
 ******************************************************************************/
//static void IncomingData(afIncomingMSGPacket_t* pMsg)
...
{
   /* static const IN_AfIncomingData_Callback_t s_pIN_IncomingData_Callback =
    {
        IncomingData,
        -1
    };

    N_PacketDistributor_RegisterInterPanEndpoint(&s_endpointDescription);

    IN_AfIncomingData_Subscribe(INTERPAN_ENDPOINT, &s_pIN_IncomingData_Callback);*/
    s_initialised = TRUE;

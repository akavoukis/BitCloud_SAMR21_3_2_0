...
/* Timeout which OTA client waits for the first Image Block Response
  in response to Image Page Request or the completion of page download. */
...
#define OTAU_MAX_RESPONSE_WAIT_TIMEOUT       WAITING_BLOCK_RESPONSE_TIMEOUT
...
#define OTAU_PDT_MEMORY_MEM_ID               OTAU_DIR1_MEM_ID

...
PROGMEM_DECLARE(PDS_MemId_t otauPdtMemoryIdsTable[]) =
{
...
PDS_DECLARE_DIR(PDS_DirDescr_t otauPdtMemoryDirDescr) =
{
  .list       = otauPdtMemoryIdsTable,
  .filesCount = ARRAY_SIZE(otauPdtMemoryIdsTable),
  .memoryId   = OTAU_PDT_MEMORY_MEM_ID
};

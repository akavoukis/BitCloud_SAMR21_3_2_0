...
#define BSP_readKEY0() (GPIO_A19_read())
#endif
...
#elif BSP_SUPPORT == BOARD_SAMR21_CUSTOM
#define BUTTON_IRQ IRQ_EIC_EXTINT3
#endif
...
#elif BSP_SUPPORT == BOARD_SAMR21_CUSTOM 
  GPIO_A15_make_in();
  GPIO_A15_make_pullup();
  PORTA_PINCFG15_s.pmuxen = 1;
  PORTA_PINCFG15_s.inen = 1;
  PORTA_PMUX7_s.pmuxo = 0;
#else

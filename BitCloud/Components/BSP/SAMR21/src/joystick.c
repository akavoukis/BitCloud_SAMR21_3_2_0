...
#define IS_JOYSTICK_UP_ACTION(x) (x > 35 && x < 45)
#define IS_JOYSTICK_LEFT_ACTION(x) (x > 60 && x < 70)
#define IS_JOYSTICK_DOWN_ACTION(x) (x > 115 && x < 125)
#define IS_JOYSTICK_RIGHT_ACTION(x) (x > 165 && x < 180)
#define IS_JOYSTICK_PUSH_ACTION(x) (x > 210 && x < 235)
/******************************************************************************
                   Types section
******************************************************************************/
typedef enum

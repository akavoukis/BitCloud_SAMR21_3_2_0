/**************************************************************************//**
  \file ciTimeCluster.c

  \brief
    Combined Interface time cluster implementation.
...
void timeClusterInit(void)
{
  ...
  ZCL_Cluster_t *cluster = ZCL_GetCluster(APP_SRC_ENDPOINT_ID, TIME_CLUSTER_ID, ZCL_CLUSTER_SIDE_SERVER);

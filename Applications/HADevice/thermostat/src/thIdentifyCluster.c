/**************************************************************************//**
  \file thIdentifyCluster.c

  \brief
    Thermostat Identify cluster implementation.
...
static void thFillIdentifyQueryResponsePayload(ZCL_IdentifyQueryResponse_t *payload, uint16_t time);
...
******************************************************************************/
ZCL_IdentifyClusterAttributes_t thIdentifyClusterServerAttributes =
{
  ZCL_DEFINE_IDENTIFY_CLUSTER_SERVER_ATTRIBUTES()
};
ZCL_IdentifyClusterCommands_t   thIdentifyCommands =
{
...
{
  thIdentifyClusterServerAttributes.commissioningState.value.networkState     = nwkState;
  thIdentifyClusterServerAttributes.commissioningState.value.operationalState = operationalState;
}
...
static ZCL_Status_t updateCommissioningStateInd(ZCL_Addressing_t *addressing, uint8_t payloadLength, ZCL_UpdateCommissioningState_t *payload)
{
  ...
  {
    thIdentifyClusterServerAttributes.commissioningState.value.networkState     |= payload->commissioningStateMask.networkState;
    thIdentifyClusterServerAttributes.commissioningState.value.operationalState |= payload->commissioningStateMask.operationalState;
  }
...
static ZCL_Status_t sendIdentifyQueryResponse(ZCL_Addressing_t *addressing)
{
  ...
  thFillIdentifyQueryResponsePayload((ZCL_IdentifyQueryResponse_t *)req->requestPayload, thIdentifyClusterServerAttributes.identifyTime.value);

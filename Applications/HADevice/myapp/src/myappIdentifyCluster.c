/**************************************************************************//**
  \file dlIdentifyCluster.c

  \brief
    Dimmable Light Identify cluster implementation.
...
******************************************************************************/
ZCL_IdentifyClusterAttributes_t dlIdentifyClusterServerAttributes =
{
  ZCL_DEFINE_IDENTIFY_CLUSTER_SERVER_ATTRIBUTES()
};
ZCL_IdentifyClusterCommands_t   dlIdentifyCommands =
{
  IDENTIFY_CLUSTER_COMMANDS(identifyInd, identifyQueryInd, NULL, ezModeInvokeInd, updateCommissioningStateInd)
};
